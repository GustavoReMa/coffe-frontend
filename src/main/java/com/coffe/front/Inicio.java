...
/**
 * Clase que cuenta con la funcionalidad de aceptar datos y mandarlos a los
 * controladores para verificar los datos en la base de datos y si existen
 * abrirles la interfaz correspondiente
 */
